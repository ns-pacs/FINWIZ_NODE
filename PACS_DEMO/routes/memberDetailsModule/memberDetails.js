...
router.post('/mem_details_add',function(req,res){
    ...
    pgdbconnect.query("select * from member_details ",function(err,memresult){
...
//     console.log("counter payyyy",edit_cntr_pay)
...
//     console.log("data of member",view_mem_typ,view_mem_id,view_emp_code,view_doj,view_dor,view_adm_no,view_dept,view_ent_fee,view_shr_bal,view_crncytyp,view_thrift_dept,view_dras,view_bnk_acc_no,view_opn_bal,view_cls_bal)
