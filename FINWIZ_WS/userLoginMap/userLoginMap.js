...
module.exports.getUserByUsername = function(username,callback){
    ...
    var query=pgdbconnect.query("SELECT u.ud_ch_emp_id,u.ud_ch_password,u.ud_ch_email_id,u.ud_ch_role_id, u.ud_ch_role_name, u.ud_ch_del_flg, u.ud_ch_entity_cre_flg, u.ud_ch_login_allowed FROM user_details u WHERE u.ud_ch_emp_id = $1",[username],function(err,result){
